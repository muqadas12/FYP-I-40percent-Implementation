...
const addData = (req, res) => {
    ...
    dataCases.map(dataa => {
        const {caseCode,caseName,Caseno,Caseyear,Bench,Circuitcode,CASETITLE,Matter,LastHearing,NextDate} = dataa;
        const data = new casesSchema({
            caseCode,caseName,Caseno,Caseyear,Bench,Circuitcode,CASETITLE,Matter,LastHearing,NextDate
        });
        data.save()
            .then(SavedData => {
