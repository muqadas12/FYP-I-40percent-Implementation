...
function Card3() {
  ...
  <div class="card-body">
    ...
    <div className="col-sm">
    <div class="card" >
  <img src="https://static.vecteezy.com/system/resources/previews/000/150/042/original/press-release-vector-art.jpg" class="card-img-top" alt="..."/>
  <div className="card-body">
    ...
    <div className="col-sm">
    <div className="card" >
  <img src="https://www.vakilno1.com/wp-content/uploads/2018/06/lawyer.jpg" className="card-img-top" alt="..."/>
  <div className="card-body">
